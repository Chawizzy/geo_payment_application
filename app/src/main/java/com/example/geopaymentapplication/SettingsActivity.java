...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Theme
        SwitchCompat mySwitchCompat = findViewById(R.id.my_switch);

        if (sharedPref.loadNightModeState()) {
            mySwitchCompat.setChecked(true);

            mySwitchCompat.setText("Light Theme");
        } else {
            mySwitchCompat.setChecked(false);

            mySwitchCompat.setText("Dark Theme");
        }

        mySwitchCompat.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
